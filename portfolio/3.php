<div id="ajax-page" class="ajax-page-content">
    <div class="ajax-page-wrapper">
        ...
        <div class="ajax-page-title">
            <h1>Scott County Arts Council</h1>
        </div>
        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    <div class="item">
                        <img src="../assets/images/portfolio/port-3-1.jpg" alt="" />
                    </div>
                    <div class="item">
                        <img src="../assets/images/portfolio/port-3-2.jpg" alt="" />
                    </div>
                ...
                <div class="portfolio-page-image">
                    <img src="images/portfolio/port-3-1.jpg" alt="">
                </div>
                -->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="http://dawsonrichey.com/src/code_louisville/index.html" target="_blank">Scott County Arts Council</a></p></li>
