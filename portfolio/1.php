        ...
        <div class="row">
              <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    ...
                    <div class="item">
                        <img src="../assets/images/portfolio/port-1-2.jpg" alt="" />
                    </div>
                ...
                <div class="portfolio-page-image">
                    <img src="images/portfolio/port-1.jpg" alt="">
                </div>
                -->
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    ...
                    <li><p><i class="fa fa-globe"></i> <a href="https://www.cagleautogroup.com/" target="_blank">www.cagleautogroup.com</a></p></li>
                    <li><p><i class="fa fa-calendar"></i> August 2018</p></li>
                </ul>

                <!--<p class="text-justify">Aliquam euisum primis in faucibus.</p>-->
                <!-- /Project Description -->
